  ...
  const faqs = [
    {
      ...
      a: "The NemoClaw AI Agents Ecosystem is a collection of specialized autonomous agents (Pico, Zero, Kimi, OpenClaw, Tiny, Iron, Research, Mimo) optimized for different hardware and reasoning requirements within the Nemo infrastructure."
    },
    {
