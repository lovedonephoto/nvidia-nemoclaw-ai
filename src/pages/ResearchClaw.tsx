...
import { Search, Globe, FileText, CheckCircle2, Terminal, ArrowLeft, Star, ArrowRight, Box, Brain, Database, Layers } from "lucide-react";
...
const ResearchClaw = () => {
  useEffect(() => {
    const pageTitle = "ResearchClaw AI | install Research Claw Github, Skills, Docker";
    const pageDesc = "Install ResearchClaw AI agent. Get the official Research Claw Github code, specialized AI skills, and Docker setup guide for automated deep-dive research runs.";
    ...
    if (link) {
      link.setAttribute("href", "https://nemoclawaiapp.com/researchclaw");
    }
    window.scrollTo(0, 0);
  }, []);

  const features = [
    { title: "Multi-Hop Web Search", description: "Navigates complex search results to find deep-web information." },
    { title: "Source Verification", description: "Cross-references data points against multiple trusted authorities." },
    { title: "Automated Synthesis", description: "Summarizes thousands of pages into actionable reports." },
    { title: "Structured Knowledge", description: "Outputs research in JSON, Markdown, or PDF formats automatically." }
  ];

  const faqs = [
    {
      q: "What is ResearchClaw?",
      a: "ResearchClaw is an autonomous agent designed for deep information retrieval. Unlike a simple search, it reasons through web content, follows links, and builds a comprehensive knowledge base on any topic."
    },
    {
      q: "How does it verify sources?",
      a: "It uses a reputation-based scoring system for domains and cross-references facts across at least three independent sources before including them in a final report."
    }
  ];
    ...
    <main className="min-h-screen bg-background text-foreground selection:bg-primary/30">
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "name": "ResearchClaw AI Agent",
          "applicationCategory": "AI Software",
          "description": "Autonomous research agent for deep web investigation and content synthesis.",
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h2 className="text-2xl md:text-5xl font-bold mb-10 text-white leading-tight max-w-4xl tracking-tight">
              ResearchClaw AI | <span className="italic opacity-80">install Research Claw</span> Github, Skills, Docker
            </h2>

            <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-12 leading-relaxed italic">
              Professional automation scripts, research templates, and synthesis configurations to deploy <strong>ResearchClaw AI</strong> agents for <strong>Autonomous</strong> deep-dive investigations.
            </p>
      ...
      <section className="py-24 relative bg-foreground/[0.01]">
        <div className="container mx-auto px-4 max-w-5xl">
          <h2 className="text-4xl sm:text-6xl font-display font-black mb-12 italic tracking-tighter">install ResearchClaw</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-muted-foreground text-lg leading-relaxed italic">
                ResearchClaw is built for the information age. Follow our <strong>install ResearchClaw</strong> guide to start your first deep-dive.
              </p>
              <div className="space-y-4">
                {[
                  "Automated Browser Driver Setup",
                  "Scraping & Parsing Logic (LLM-based)",
                  "PDF & Markdown Export Plugins",
            ...
            <div className="glass-panel p-8 rounded-[40px] border-border/40 bg-zinc-900/50 font-mono text-sm leading-relaxed">
              ...
              <div className="text-primary/40 mb-2"># Install ResearchClaw CLI</div>
              <div className="text-white mb-6">curl -sSL https://get.nemoclaw.ai/install | bash -s -- agent=researchclaw</div>
              <div className="text-primary/40 mb-2"># Start Researching</div>
              <div className="text-white">researchclaw search "Future of AI Edge Computing"</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-12">
            <div className="lg:w-1/2">
               <h2 className="text-4xl sm:text-6xl font-display font-black mb-6 italic tracking-tighter">ResearchClaw Github</h2>
               <p className="text-muted-foreground text-lg leading-relaxed italic mb-8">
                  The **ResearchClaw Github** contains the core browser automation and synthesis logic. Star our research mission.
               </p>
               <div className="flex gap-8">
                  <div className="text-center">
                    <div className="text-3xl font-black text-white">5.8k</div>
            ...
            <div className="lg:w-1/2 w-full">
               <div className="glass-panel p-10 rounded-[3rem] border-white/5 bg-white/[0.02] relative group overflow-hidden text-center">
                  ...
                  <h4 className="text-xl font-bold mb-6">Autonomous Repo</h4>
      ...
      <section className="py-24 relative">
        <div className="container mx-auto px-4 max-w-5xl">
          <h2 className="text-4xl sm:text-6xl font-display font-black mb-12 italic tracking-tighter text-center">ResearchClaw Skills</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "Internet Reasoning", desc: "Plan search strategies and pivot based on findings.", icon: Brain },
              { title: "Data Synthesis", desc: "Convert unstructured web data into clean reports.", icon: FileText },
              { title: "Truth Mapping", description: "Cross-validate claims across reliable databases.", icon: Database }
            ].map((skill, sIdx) => (
      ...
      <section className="py-24 relative bg-foreground/[0.01] border-t border-border/40">
        <div className="container mx-auto px-4 max-w-5xl text-center">
          <h2 className="text-4xl sm:text-6xl font-display font-black mb-8 italic tracking-tighter">ResearchClaw Docker</h2>
          <p className="text-muted-foreground text-lg mb-16 max-w-3xl mx-auto italic">
            Run the entire research stack in a container. Use **ResearchClaw Docker** for scalable investigation pipelines.
          </p>
          <div className="glass-panel p-10 rounded-[40px] border-border/40 bg-[#050505] text-left">
            ...
            <div className="font-mono text-sm leading-relaxed space-y-2">
              ...
              <div className="pl-4 text-primary/60">research-core:</div>
              <div className="pl-8 text-primary/60 italic">image: <span className="text-white">nemoclaw/researchclaw:latest</span></div>
              <div className="pl-8 text-primary/60 italic">ports:</div>
              <div className="pl-12 text-primary/60 italic">- <span className="text-white">"8080:8080"</span></div>
              <div className="pl-8 text-primary/60 italic">environment:</div>
              <div className="pl-12 text-primary/60 italic">- <span className="text-white">SEARCH_ENGINE=serpapi</span></div>
            </div>
          </div>
        </div>
      </section>
