...
const InstallNemoClaw = () => {
  useEffect(() => {
    document.title = "Install NemoClaw | AI Agent Setup Guide";
    
    let metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Step-by-step guide to install NemoClaw. Automated setup for GPUs, Mac Apple Silicon, and enterprise Linux servers. Get started with AI reasoning agents in 5 minutes.");
    }
    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30">
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl">
          ...
          <div className="glass-panel p-10 rounded-[2rem] border-white/5 relative overflow-hidden group">
            ...
            <ul className="space-y-4 text-sm text-muted-foreground">
               ...
               <li className="flex items-center gap-3"><CheckCircle2 className="w-4 h-4 text-primary" /> Driver 535+ & CUDA 12.x</li>
               <li className="flex items-center gap-3"><CheckCircle2 className="w-4 h-4 text-primary" /> Docker + Container Toolkit</li>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Post-installation, our setup kit generates a <code>.env.hardened</code> file. You will need to configure your model paths and API access keys for <strong>NIM</strong> or local <strong>vLLM</strong> backends.
              </p>
            ...
            <div className="bg-black/60 rounded-[2rem] border border-white/10 p-8 font-mono text-sm leading-relaxed overflow-hidden relative shadow-2xl">
               ...
               <div className="space-y-2 text-white/70 relative z-10">
                 ...
                 <p><span className="text-primary">_NIM_KEY</span>=nvapi-XXXX...</p>
           ...
           <div className="space-y-12 relative before:absolute before:left-[1.5rem] before:top-0 before:bottom-0 before:w-px before:bg-white/10">
              {[
                ...
                },
                {
                   ...
                   desc: "NemoClaw automatically detects your hardware and installs the optimized TensorRT-LLM drivers for the Nemotron 3 model family.",
                   icon: 2
                },
                {
      ...
      <script type="application/ld+json">
        {`
        {
          ...
          "description": "Step-by-step guide to installing the-accelerated NemoClaw AI platform on Mac and Linux.",
          "step": [
            {
              "@type": "HowToStep",
